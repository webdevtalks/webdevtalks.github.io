  ...
  return (
    <>
      ...
      <Container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', pt: 5 }}>
        ...
        <Typography variant="h2">{t("aboutUs.socialImpact")}</Typography>
        <Typography>{t("aboutUs.socialImpactBody1")}</Typography>
        <Typography variant="h2">{t("aboutUs.jobsOffer")}</Typography>
        <Typography>{t("aboutUs.jobsOfferBody1")}</Typography>
        <Typography variant="h2">{t("sponsorship.sponsor")}</Typography>
        <Typography>{t("aboutUs.sponsorBody")}</Typography>
        <Typography variant="h2">{t("aboutUs.offer")}</Typography>
        ...
        <Typography variant="h3">{t("aboutUs.communityHeader")}</Typography>

        <Avatar variant="square" src={image4} alt="" sx={{ width: '100%', height: '100%', my: 5 }} />
      </Container>
    </>
  )
}
