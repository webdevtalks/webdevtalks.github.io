    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Close className="ml-auto inline-flex h-10 w-10 items-center justify-center rounded-full text-slate-500 transition hover:bg-black/5 hover:text-slate-950">
            <X className="h-5 w-5" />
          </Dialog.Close>
          {children}
        </Dialog.Content>
